"""
Evaluation — Workload A17 (QD1) — Basic Time-Series
=====================================================
Usage:
    python 30_eval_workload_17_basic.py <eval_data> <models_joblib>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Workload A17 QD1 basic evaluation.")
    parser.add_argument("data_path"); parser.add_argument("models_path")
    parser.add_argument("--model", default="LASSO_POLY")
    parser.add_argument("--output", default="evaluation_workload_17_QD1.pdf")
