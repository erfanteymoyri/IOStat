"""
Evaluation — FIUMail J4 QD1 — Basic Time-Series
=================================================
Plots IOstat, True Utilization, and model-predicted utilization for the
FIUMail workload replay (Job 4, Queue Depth 1).

Usage:
    python 22_eval_fiumail_qd1_basic.py <eval_data> <models_joblib>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="FIUMail J4 QD1 basic evaluation."
    )
    ...
    parser.add_argument("--output", default="evaluation_fiumail_j4_qd1.pdf")
